...
public class RandomHelloTest {
  ...
  public void testCrash() {
    // If RandomHello.main() throws an exception, it will propagate
    // outside testCrash() and JUnit will flag an error.
  ...
  public void testGreetings() {
    ...
    assertEquals(
        "Wrong number of greetings in RandomHello", REQUIRED_NUMBER_OF_GREETINGS, set.size());
  }
}
