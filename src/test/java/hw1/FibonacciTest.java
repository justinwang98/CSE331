 ...
 *
 * <p>Thus, the Fibonacci sequence starts out as 1, 1, 2, 3, 5, 8, 13... The first 1 in the sequence
 * is considered the "0th" term, so the indices that <code>hw1.Fibonacci</code> uses are 0-based.
 */
