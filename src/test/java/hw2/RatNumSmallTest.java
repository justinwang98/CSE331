 ...
 * implementation of the RatNum class. For a more complete test, see <tt>RatNumTest</tt>. This
 * class, <tt>RatNumSmallTest</tt>, deliberately omits some of the tests from <tt>RatNumTest</tt>,
 * to permit comparing the effects of the two test suites.
 */
